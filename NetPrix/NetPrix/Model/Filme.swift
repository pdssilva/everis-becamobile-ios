...
//    //Mark: - init
//
//    init (_ originalName: String, _ id: Int, _ name: String, _ voteCount: Int, _ voteAverage: Double, _ firstAirDate: String, _ posterPath: String, _ genreIDS: [Int], _ originalLanguage: OriginalLanguage, _ backdropPath: String, _ overview: String,
//          _ originCountry: [String], _ popularity: Double, _ mediaType: MediaType, _ adult: Bool, _ originalTitle: String, releaseDate: String, title: String, video: Bool){
//
//        self.originalName = originalName
//        self.id = id
//        self.name = name
